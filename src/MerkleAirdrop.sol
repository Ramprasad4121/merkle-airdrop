...
import { MessageHashUtils } from "murky/lib/openzeppelin-contracts/contracts/utils/cryptography/MessageHashUtils.sol";
...
contract MerkleAirdrop is EIP712 {
        ...
        returns (bool)
    {
        ...
        (address actualSigner, ECDSA.RecoverError recoverError) = ECDSA.tryRecover(digest, _v, _r, _s);
